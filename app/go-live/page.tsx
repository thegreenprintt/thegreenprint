...
export default function GoLivePage() {
  ...
  const [statusLog, setStatusLog] = useState("Ready ÃÂ¢ÃÂÃÂ press Go Live to start.");
  ...
  function startPeer() {
    ...
    peer.on("open", (id: string) => {
      log(`ÃÂ¢ÃÂÃÂ Broadcaster ready ÃÂ¢ÃÂÃÂ ID: ${id}. Press Go Live when ready.`);
    });
    ...
    peer.on("error", (err: any) => {
      if (err.type === "unavailable-id") {
        log("ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Stream ID already in use ÃÂ¢ÃÂÃÂ you may already be live in another tab.");
      } else {
        log(`Peer error: ${err.message}. ReconnectingÃÂ¢ÃÂÃÂ¦`);
  ...
  async function goLive() {
    if (!navigator.mediaDevices?.getDisplayMedia) {
      log("ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ Use Chrome or Edge on desktop for screen sharing.");
      return;
    }
    log("Choose your screen ÃÂ¢ÃÂÃÂ select 'Share Audio' if you want system sound.");
    try {
      ...
      log("Screen captured ÃÂ¢ÃÂÃÂ requesting micÃÂ¢ÃÂÃÂ¦");
      ...
      try {
        ...
        if (screenAudio.length > 0) {
          ...
          log("ÃÂ¢ÃÂÃÂ Screen + mic audio mixed. Going liveÃÂ¢ÃÂÃÂ¦");
        } else {
          log("ÃÂ¢ÃÂÃÂ Mic ready (no screen audio selected). Going liveÃÂ¢ÃÂÃÂ¦");
        }
        ...
        log("ÃÂ¢ÃÂÃÂ Mic ready. Going liveÃÂ¢ÃÂÃÂ¦");
      }

      const liveTitle = title || "The Greenprint ÃÂ¢ÃÂÃÂ Live Session";
      setIsLive(true);
      await setLiveStatus(true, liveTitle);
      log(`ÃÂ°ÃÂÃÂÃÂ´ LIVE ÃÂ¢ÃÂÃÂ broadcasting to ${Object.keys(viewersRef.current).length} viewer(s). Calling all waiting viewersÃÂ¢ÃÂÃÂ¦`);
  ...
  /* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Auth gate ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  if (!authed) {
    return (
      <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="relative w-full max-w-sm bg-[#111] border border-white/8 rounded-2xl p-8">
          ...
          <p className="text-center text-xs text-white/30 mb-6">The Greenprint ÃÂ¢ÃÂÃÂ Go Live Control Room</p>
  ...
  /* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Broadcaster control room ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */
  return (
    <div className="min-h-screen bg-[#080808] flex flex-col font-sans">
      ...
      <div className="h-12 bg-[#0d0d0d] border-b border-white/5 flex items-center px-4 gap-4 shrink-0">
        ...
        <span className="text-xs text-white/30 flex-1 truncate">
          The Greenprint ÃÂ¢ÃÂÃÂ Go Live Control Room
        </span>
      ...
      <div className="flex flex-1 overflow-hidden flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-80 bg-[#0d0d0d] border-t lg:border-t-0 lg:border-l border-white/5 flex flex-col shrink-0">
          ...
          <div className="p-4 border-b border-white/5">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <button onClick={toggleMic}
                ...
                ÃÂ°ÃÂÃÂÃÂ {micOn ? "Mic On" : "Muted"}
              </button>
          ...
          {/* App QR ÃÂ¢ÃÂÃÂ show on stream so viewers can join */}
          <div className="p-3 border-b border-white/5">
            <p className="font-mono text-[10px] tracking-widest uppercase text-white/25 mb-2">Show on Stream ÃÂ¢ÃÂÃÂ Join App</p>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/25 leading-relaxed">$29.99/mo ÃÂ¢ÃÂÃÂ scan to join<br/>full access + mobile app</p>
                <button

export const metadata = {
  title: "Websites and Systems That Bring You Customers | The Greenprint",
  description: "I build your website, set up your signups and follow ups, and keep your customers organized. Clear prices, clear timelines.",
};
  ...
  return (
    <div className="gp-prices">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .gp-prices h1{font-family:'Sora',sans-serif;font-weight:800;font-size:clamp(38px,6vw,70px);line-height:1.04;letter-spacing:-.03em;margin:24px 0 0;background:linear-gradient(180deg,#FFFFFF 32%,#7FEFC0 122%);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}
        .gp-prices .sub{color:rgba(245,248,246,.6);font-size:clamp(15px,1.6vw,19px);max-width:620px;margin:20px auto 0;line-height:1.6}
        ...
        .gp-prices .ic{width:36px;height:36px;border-radius:11px;background:rgba(0,229,138,.12);border:1px solid rgba(0,229,138,.25);display:flex;align-items:center;justify-content:center;flex:0 0 auto}
        .gp-prices .ic svg{width:18px;height:18px}
        .gp-prices .colhead{font-family:'Sora',sans-serif;font-size:15px;font-weight:700;color:#F5F8F6;letter-spacing:-.01em;line-height:1.2}
      ...
      <div className="wrap">
        <div className="hero">
          <span className="pill"><span className="dot" />The Greenprint · Websites and Systems</span>
          <h1>Websites and systems that bring you customers.</h1>
          <p className="sub">I build your website, set up your signups and follow ups, and keep your customers organized. Clear prices. Clear timelines.</p>
        ...
        <div className="grid">
          <div className="card">
            ...
            <div className="pkg"><div className="pt"><b>One Page Website</b><span>A single page that sells your offer and lets people reach you. Looks great on phones.</span></div><div className="pp"><b>$1,500</b><span>1 to 2 wks</span></div></div>
            <div className="pkg"><div className="pt"><b>Business Website</b><span>A full site, up to 5 pages, matched to your brand, with contact forms and set up to show up on Google.</span></div><div className="pp"><b>$3,000</b><span>2 to 3 wks</span></div></div>
            <div className="pkg"><div className="pt"><b>Membership Website</b><span>Customers make an account, pay you monthly, and log into their own area. Runs on its own.</span></div><div className="pp"><b>$6,000+</b><span>4 to 6 wks</span></div></div>
          </div>
          ...
          <div className="card feat">
            ...
            <div className="ctop">
              ...
              <span className="colhead">Get and Follow Up With Customers</span>
            </div>
            <div className="pkg"><div className="pt"><b>Instant Signup Alerts</b><span>The second someone signs up, their name, phone, and email hit your phone so you can reach out right away.</span></div><div className="pp"><b>$750</b><span>3 to 5 days</span></div></div>
            <div className="pkg"><div className="pt"><b>Auto Welcome Helper</b><span>A helper in your Telegram that greets new people, sends the links they need, and answers common questions.</span></div><div className="pp"><b>$500</b><span>3 to 5 days</span></div></div>
            <div className="pkg"><div className="pt"><b>Signup Alerts and Organizer</b><span>The alerts above, plus every new customer saved in one place so you never lose track.</span></div><div className="pp"><b>$1,500</b><span>1 to 2 wks</span></div></div>
            <div className="pkg"><div className="pt"><b>Hands Off Signup System</b><span>Someone pays and it all happens on its own: account made, welcome email sent, added to your group, walked through setup.</span></div><div className="pp"><b>$3,000</b><span>2 to 3 wks</span></div></div>
          </div>
          ...
          <div className="card">
            <div className="ctop">
              ...
              <span className="colhead">Keep Customers Organized</span>
            </div>
            <div className="pkg"><div className="pt"><b>Customer Organizer</b><span>One simple place that keeps every customer in order, so you always know who to call and who paid.</span></div><div className="pp"><b>$1,000</b><span>1 week</span></div></div>
            <div className="pkg"><div className="pt"><b>Organizer and Website Hookup</b><span>The organizer above, connected to your site so new signups drop in by themselves.</span></div><div className="pp"><b>$1,500</b><span>1 to 2 wks</span></div></div>
            <div className="pkg"><div className="pt"><b>Team Organizer</b><span>The same system for a whole team, so you can see who each person brought in.</span></div><div className="pp"><b>$2,000</b><span>2 weeks</span></div></div>
          </div>
        </div>
        ...
        <div className="grid2">
          <div className="card">
            ...
            <div className="addon"><span>Take payments and monthly memberships</span><span className="ap">$500</span></div>
            <div className="addon"><span>Up to 5 welcome emails that send on their own</span><span className="ap">$500</span></div>
            <div className="addon"><span>Words written to sell, per page</span><span className="ap">$300</span></div>
            <div className="addon"><span>A backup of every signup in a simple spreadsheet</span><span className="ap">$150</span></div>
            <div className="addon"><span>Get your web address and hosting set up</span><span className="ap">$150</span></div>
            <div className="addon"><span>One extra round of changes</span><span className="ap">$100</span></div>
          </div>

          <div className="card">
            <div className="ctop"><span className="colhead">Monthly Care Plans</span></div>
            <div className="pkg"><div className="pt"><b>Basic</b><span>I keep your site running and fix anything that breaks.</span></div><div className="pp"><b>$100</b><span>a month</span></div></div>
            <div className="pkg"><div className="pt"><b>Growth</b><span>Everything in Basic, plus small updates each month.</span></div><div className="pp"><b>$250</b><span>a month</span></div></div>
            <div className="pkg"><div className="pt"><b>Full Service</b><span>Everything in Growth, plus new pages, new features, and you get answered first.</span></div><div className="pp"><b>$500</b><span>a month</span></div></div>
          </div>
        </div>

        <div className="steps">
          <div className="step"><span className="n">1</span><p>Quick call to go over what you need and lock in the price.</p></div>
          <div className="step"><span className="n">2</span><p>Pay half to get started.</p></div>
          <div className="step"><span className="n">3</span><p>I build it. You get 2 rounds of changes.</p></div>
          <div className="step"><span className="n">4</span><p>Pay the other half when it goes live.</p></div>
        </div>
        <p className="stepnote">You give me access to your accounts. The timeline starts once the deposit and access are in.</p>

        <div className="final">
          <h3>Ready to build?</h3>
          <p>Tell me what you want and I will show you the fastest way to get it done.</p>
          <a className="btn primary" href="mailto:info@thegreenprint.trade?subject=Build%20inquiry">Contact info@thegreenprint.trade</a>
        </div>
      </div>

      <footer>The Greenprint. Contact <a href="mailto:info@thegreenprint.trade">info@thegreenprint.trade</a>. Prices in USD.</footer>
    </div>
  );
}

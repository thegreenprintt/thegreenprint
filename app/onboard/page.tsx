      ...
      <div className="max-w-lg mx-auto px-6 pt-12 pb-24">
        ...
        {step === 2 && (
          <div>
            ...
            <h2 className="text-2xl font-bold text-white mt-3 mb-4">Full Onboarding</h2>
            <p className="text-white/50 text-sm leading-relaxed mb-6">If you're not getting phone guidance, watch this video. Otherwise, follow the next steps.</p>
            <div className="aspect-video bg-black/50 border border-white/20 rounded-xl mb-6 flex items-center justify-center overflow-hidden">
              <video controls className="w-full h-full" style={{ objectFit: 'contain' }}>
                <source src="https://drive.google.com/uc?id=197t2VfgGJEHYr_NFy79ZTOwXEsEE5RQr&export=download" type="video/mp4" />
        ...
        {step === 4 && (
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://t.me/+1rvPMKd6MRw3NGUx" target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
        ...
        {step === 6 && (
          <div>
            ...
            <h2 className="text-2xl font-bold text-white mt-3 mb-4">TradeLocker Phone Overview</h2>
            <p className="text-white/50 text-sm leading-relaxed mb-6">Master TradeLocker platform setup and trading execution.</p>
            <div className="aspect-video bg-black/50 border border-white/20 rounded-xl mb-6 flex items-center justify-center overflow-hidden">
              <video controls className="w-full h-full" style={{ objectFit: 'contain' }}>
                <source src="https://drive.google.com/uc?id=1KoIlb3yrBQ7pvAhqM8_RkEA5KIC07Gu6&export=download" type="video/mp4" />
                Your browser does not support the video tag.
              </video>
            </div>
          </div>

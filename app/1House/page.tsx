...
export default function OneHousePage() {
  ...
  const Tg = () => (<svg viewBox="0 0 24 24" fill="#fff" aria-hidden="true"><path d="M21.9 4.35 2.9 11.7c-.9.35-.9 1.6.03 1.94l4.86 1.7 1.86 5.62c.24.7 1.13.92 1.68.4l2.68-2.63 4.86 3.58c.6.45 1.45.12 1.6-.62l3-14.2c.18-.86-.66-1.6-1.48-1.35z" /></svg>);
  const Bell = () => (<svg viewBox="0 0 24 24" fill="none" stroke="#053" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.7 21a2 2 0 0 1-3.4 0" /></svg>);
  ...
  return (
    <div className="jp">
      <style>{`
        ...
        .jp .ic svg{width:26px;height:26px;}
      ...
      <div className="wrap">
        <div className="top">
          ...
          <h1>{step === 1 ? (<>Download your <span className="g">apps.</span></>) : step === 2 ? (<>Set up your <span className="g">accounts.</span></>) : step === 3 ? (<>Get into <span className="g">1House.</span></>) : step === 4 ? (<>Navigate <span className="g">1House.</span></>) : step === 5 ? (<>Join the <span className="g">chats.</span></>) : step === 6 ? (<>Watch the <span className="g">videos.</span></>) : (<>Where to <span className="g">start.</span></>)}</h1>
          <p className="sub">{step === 1 ? "Brand new? Perfect. Start here. Grab the apps and open your free broker account." : step === 2 ? "Sign in to LivvFX first, then set up a demo account to practice with, zero risk." : step === 3 ? "1House.tv is your home base. Let's get you logged in." : step === 4 ? "Here's where everything lives so you never feel lost." : step === 5 ? "These are the rooms you live in. Join them and turn on notifications." : step === 6 ? "The first thing to do inside 1House. Watch these in order and you'll be ready to trade." : "A few keys to start strong, then you're off."}</p>
        </div>

        <span className="flag">STEP {step} OF 7</span>

        {step === 1 && (
          <div className="gstep">
            <div className="bar"><div className="track"><div className="fill" style={{ width: (count / 4) * 100 + "%" }} /></div><div className="barlbl"><b>{count}</b> of 4 done</div></div>
            ...
            <div className={"card" + (done[1] ? " done" : "")}>
              <div className="row">
                ...
                <div className="it"><b>Get Telegram</b><span>Where the chats and signals live</span></div>
            ...
            <div className={"card" + (done[2] ? " done" : "")}>
              <div className="row">
                <div className="ic"><img src="https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/25/29/e2/2529e2c2-c601-dcf0-cf02-5181fe12e098/AppIcon-0-0-1x_U007epad-0-1-85-220.png/512x512bb.jpg" alt="1House" /></div>
                <div className="it"><b>Get 1House</b><span>Your home for the live streams and lessons</span></div>
                <button className="tick" onClick={() => mark(2)} aria-label="Mark done">{done[2] ? "✓" : ""}</button>
              </div>
              <div className="acts">
                <a className="store" href="https://apps.apple.com/us/app/1house/id6754260060" target="_blank" rel="noopener noreferrer"><Apple /> App Store</a>
                <a className="store" href="https://play.google.com/store/apps/details?id=com.onehouseglobaldevelopment.mobile" target="_blank" rel="noopener noreferrer"><Play /> Google Play</a>
              </div>
            </div>

            <div className={"card" + (done[3] ? " done" : "")}>
              <div className="row">
                ...
                <button className="tick" onClick={() => mark(3)} aria-label="Mark done">{done[3] ? "✓" : ""}</button>
              </div>
            ...
            <button className="btn primary" disabled={count < 4} onClick={() => setStep(2)}>{count < 4 ? "Tap all 4 to continue (" + count + "/4)" : "Next: set up your accounts →"}</button>
          </div>
        )}
        ...
        {step === 2 && (
          <div className="gstep">
            ...
            <div style={{ margin: "4px 0 6px" }}>
              ...
              <div className="tk"><div className="line" /><div className="dot">4</div><div className="tx"><b>Set balance and leverage</b><span>Balance $1,000 to $10,000, leverage 1:500, then Submit.</span></div></div>
        ...
        {step === 4 && (
          <div className="gstep">
            ...
            <div style={{ margin: "4px 0 6px" }}>
              ...
              <div className="tk"><div className="dot">3</div><div className="tx"><b>Lessons and library</b><span>Go at your own pace, anytime.</span></div></div>
            </div>
            <div style={{ display: "flex", gap: 10, alignItems: "center", justifyContent: "space-between", marginTop: 14 }}>
          ...
          <div className="gstep">
            ...
            <div className="card">
              <div className="row">
                ...
                <div className="it"><b>The Greenprint Chat</b><span>The main community. Ask questions, talk with other members, and get support. This is where everybody hangs out.</span></div>
              </div>
              <a className="cta" href="https://t.me/+NFLNaB00u65mOTM5" target="_blank" rel="noopener noreferrer">Join the Greenprint chat →</a>
            </div>
            <div className="card">
              <div className="row">
                <div className="ic br"><Bell /></div>
                <div className="it"><b>GP Free Signals</b><span>The signals room. Every trade call comes through here. Tap in so you never miss one.</span></div>
              </div>
              <a className="cta" href="https://t.me/TheOnlyGreenprintBot" target="_blank" rel="noopener noreferrer">Get the free signals →</a>
            </div>
            <div style={{ display: "flex", gap: 10, alignItems: "center", justifyContent: "space-between", marginTop: 14 }}>
        ...
        {step === 6 && (
          <div className="gstep">
            <p className="sub" style={{ margin: "0 0 12px", maxWidth: "none" }}>Go to Arin Long's channel and watch these in order. Do not skip around.</p>
            <div style={{ margin: "4px 0 6px" }}>
              <div className="tk"><div className="line" /><div className="dot">1</div><div className="tx"><b>New Trader Start Here</b><span>Your very first video. Start right here.</span></div></div>
              <div className="tk"><div className="line" /><div className="dot">2</div><div className="tx"><b>Market Basics</b><span>The fundamentals every trader needs.</span></div></div>
              <div className="tk"><div className="line" /><div className="dot">3</div><div className="tx"><b>Market Bully Strategy: Four Steps</b><span>The strategy, broken into four simple steps.</span></div></div>
              <div className="tk"><div className="dot">→</div><div className="tx"><b>Keep going in order</b><span>Work straight down her channel, one video at a time.</span></div></div>
            </div>
            <a className="cta" href="https://www.1house.tv/educators/arin-long" target="_blank" rel="noopener noreferrer">Open Arin Long's channel →</a>
            <div style={{ display: "flex", gap: 10, alignItems: "center", justifyContent: "space-between", marginTop: 14 }}>
              <button className="back" onClick={() => setStep(5)}>← Back</button>
              <button className="btn primary" style={{ width: "auto", padding: "13px 24px", marginTop: 0 }} onClick={() => setStep(7)}>Next →</button>
            </div>
          </div>
        )}
        ...
        {step === 7 && (
          <div className="gstep">
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "center", justifyContent: "space-between", marginTop: 14 }}>
              <button className="back" onClick={() => setStep(6)}>← Back</button>
